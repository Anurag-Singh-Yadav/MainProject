...
function Technicalskils() {
  return (
    <div>
      <div className="flex justify-center items-center technical1 font-semibold md:font-bold  text-3xl md:text-6xl py-2 md:py-3">Technical Junction</div>
